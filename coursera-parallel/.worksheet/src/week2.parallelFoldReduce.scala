...
object parallelFoldReduce {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(376); val res$0 = 
  ...
  };System.out.println("""parReduce: [A](t: week2.FoldTree[A], f: (A, A) => A)A""");$skip(176); 
  ...
  val resSeq = reduce(foldTree, fMinus);System.out.println("""resSeq  : Int = """ + $show(resSeq ));$skip(42); 
	val resPar = parReduce(foldTree, fMinus);System.out.println("""resPar  : Int = """ + $show(resPar ));$skip(19); val res$10 = 
